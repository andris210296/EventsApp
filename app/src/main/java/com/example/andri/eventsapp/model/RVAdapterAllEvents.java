...
public class RVAdapterAllEvents extends RecyclerView.Adapter<RVAdapterAllEvents.EventViewHolder> {
    ...
    private void showPopupMenu(View view,Event event) {
        ...
        inflater.inflate(R.menu.menu_event_all_events, popup.getMenu());
